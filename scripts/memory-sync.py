...
DOMAIN_KEYWORDS = {
    ...
    'negócio': ['trios work', 'consultoria', 'pipeline', 'vendas', 'marketing'],
...
def extract_tags(title: str, content: str, domain: str) -> list[str]:
    ...
    tag_patterns = {
        ...
        'operações': ['operações', 'processo', 'processos', 'revops'],
        'ferramentas': ['ferramenta', 'tool', 'api', 'integração'],
        'família': ['família', 'samuel', 'ravi', 'priscila'],
        'negócio': ['negócio', 'empresa', 'trios', 'consultoria'],
    }
