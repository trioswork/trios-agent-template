...
def extract_domain(title, content):
    ...
    domains = {
        ...
        'clientes': ['cliente', 'contrato', 'proposta', 'marina', 'usina', 'conto', 'daysol'],
        ...
        'negócio': ['trios work', 'consultoria', 'revops', 'pipeline', 'prospecção'],
        'pessoal': ['família', 'arone', 'priscila', 'samuel', 'ravi'],
...
def extract_tags(title, content):
    ...
    tag_patterns = [
        ...
        'openclaw', 'telegram', 'whatsapp', 'usina', 'conto', 'marina',
        'daysol', 'sdrevops', 'automação', 'ia', 'llm', 'pipeline',
